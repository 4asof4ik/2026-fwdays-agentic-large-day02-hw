...
description: Explores and maps unfamiliar areas of the codebase by tracing data flow, identifying key files, and documenting dependencies. Read-only. Use when the user asks to explore, investigate, or understand how a module or feature works.
---
